...
var protectedUrls = []string{"/admin", "/apiKeys", "/auth/token", "/branding", "/brandingSave", "/changePassword", "/downloadPresigned", "/e2eSetup", "/filerequests", "/logs", "/uploadChunk", "/uploadStatus", "/users"}
