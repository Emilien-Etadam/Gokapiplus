...
func Start() {
	...
	mux.HandleFunc("/branding", requireLogin(showBranding, true, false))
	mux.HandleFunc("/branding.css", serveBrandingCss)
	mux.HandleFunc("/brandingSave", requireLogin(saveBranding, false, false))
	mux.HandleFunc("/branding/asset/{name}", serveBrandingAsset)
